 ...
 * It is not responsible for altering the execution entity (e.g. setting status to {@code EXECUTED}.
 */
public interface SubscriptionExecutor {
	/**
	 * Execute a subscription.
	 *
	 * @param execution The subscription execution
	 */
	void execute(SubscriptionExecutionEntity execution);
