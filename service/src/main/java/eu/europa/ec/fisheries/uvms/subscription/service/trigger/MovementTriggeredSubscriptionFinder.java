...
public interface MovementTriggeredSubscriptionFinder {

	Stream<SubscriptionEntity> findTriggeredSubscriptions(MovementType movement, SubscriptionSearchCriteria.SenderCriterion senderCriterion);
