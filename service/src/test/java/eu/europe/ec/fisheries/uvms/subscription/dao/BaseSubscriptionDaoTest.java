...
public abstract class BaseSubscriptionDaoTest extends BaseDAOTest {
    ...
    static final Operation INSERT_SUBSCRIPTION = sequenceOf(
            insertInto("subscription.subscription")
                    .columns("id", "subscription_guid", "name", "enabled", "organisation", "channel", "end_point", "message_type", "subscription_type", "state_type", "trigger_type", "accessibility")
                    .values(1L, "1dcc7037-bcf2-4e34-be01-c868beecf87a", "name1", "1", "organisation1", "channel2", "endpoint1", "UNKNOWN", "UNKNOWN", "UNKNOWN", "AUTO", "UNKNOWN")
                    .values(2L, "0dbe00af-a300-4cea-b1d7-1e6826ff8826", "subscription2", "1", "org1", "channel2", "endpoint2", "UNKNOWN", "UNKNOWN", "UNKNOWN", "AUTO", "UNKNOWN")
                    .values(3L, "4b25f95f-b3de-4d2e-ad99-dd2fe828a0f0", "subscription3", "1", "org1", "channel3", "endpoint3", "UNKNOWN", "UNKNOWN", "UNKNOWN", "AUTO", "UNKNOWN")
                    .values(4L, "14f7dc3c-813e-45d5-8470-3e38192ea5f9", "subscription4", "0", "org1", "channel4", "endpoint4", "UNKNOWN", "UNKNOWN", "UNKNOWN", "AUTO", "UNKNOWN")
                    .build(),
