...
public abstract class BaseSubscriptionInMemoryTest extends BaseDAOTest {
    ...
    static final Operation INSERT_SUBSCRIPTION = sequenceOf(insertInto("subscription.subscription").columns("id", "subscription_guid", "name", "enabled", "organisation", "channel", "end_point", "message_type", "subscription_type", "state_type", "trigger_type", "accessibility", "start_date", "end_date")
            .values(1L, "1dcc7037-bcf2-4e34-be01-c868beecf87a", "name1", "1", "organisation1", "channel2", "endpoint1", "UNKNOWN", "UNKNOWN", "UNKNOWN", "AUTO", "UNKNOWN", "2000-12-10 16:02:59.047",  "2020-12-10 16:02:59.047")
            .values(2L, "0dbe00af-a300-4cea-b1d7-1e6826ff8826", "subscription2", "1", "org1", "channel2", "endpoint2", "UNKNOWN", "UNKNOWN", "UNKNOWN", "AUTO", "UNKNOWN", "2000-12-10 16:02:59.047", "2020-12-10 16:02:59.047")
    ...
    static final Operation INSERT_CONDITION = sequenceOf(insertInto("subscription.condition").columns("id", "position", "subscription_id", "data_type", "criteria_type", "sub_criteria_type", "value_type", "value", "condition_type")
            .values(1L, 1L, 1, "FA_REPORT", "SENDER", "ORGANISATION", "UNKNOWN", "BEL", "START").build()
