...
/**
 * Low-level client to interesting Spatial module services.
 */
public interface SpatialClient {

    /**
     * Common usage
     * @param request The spatial module request
     */
    <T> T sendRequest(SpatialModuleRequest request,Class<T> responseClass);
}
